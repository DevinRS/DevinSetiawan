...
with col2:
    ...
    st.markdown(
        """
        Check out my <a href="http://devinsetiawan.streamlit.app/research" target="_blank">research</a> and 
        <a href="http://devinsetiawan.streamlit.app/projects" target="_blank">projects</a> to learn more about me.
        """,
        unsafe_allow_html=True
    )
...
st.markdown(
    """
    - **🔎 <a href="http://devinsetiawan.streamlit.app/research" target="_blank">Research</a>**: My recent research projects and publications.
    - **📁 <a href="http://devinsetiawan.streamlit.app/projects" target="_blank">Projects</a>**: My personal projects and open-source contributions.
    - **🎓 <a href="http://devinsetiawan.streamlit.app/teaching" target="_blank">Teaching</a>**: My teaching experiences.
    """,
    unsafe_allow_html=True
)
